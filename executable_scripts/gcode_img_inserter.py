...
def print_help(err_msg=''):
    ...
    print("OPTIONS:")
    print(bold("inserts"),"- png file to gcode file:")
    print(bold("FILE1=png_file, FILE2=gcode_file"))
...
if __name__=='__main__':
    ...
    if len(sys.argv) >= 3 and (opt == '--clear' or opt == '-c'):
        ...
        if not fpathconf.lower().endswith('.gcode'):
    ...
    # insert gcode
        ...
        if not fpathconf.lower().endswith('.gcode') or not fpath_png.lower().endswith('.png'):
